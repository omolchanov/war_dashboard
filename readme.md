...
- **`/economics`** — JSON array of objects: `period` (e.g. `2022-Q1`), `year`, `gdp_growth`, `inflation`, `trade_pct_gdp`, `debt_pct_gdp` (World Bank WDI, Russia; annual values repeated per quarter).
